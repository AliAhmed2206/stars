      ...
      <div className="max-w-6xl mx-auto px-4 py-8 relative z-10">
        ...
        <div className="flex gap-1 mb-8 glass rounded-2xl p-1.5 w-fit">
          {[
            ...
            <button key={tab.id} onClick={() => { setActiveTab(tab.id); setShowWizard(false); setShowEventForm(false) }}
          ...
          <>
              ...
              <div className="glass rounded-3xl p-6 mb-8 animate-slide-up">
                <form onSubmit={handleEventSubmit} className="space-y-4">
                  <input type="text" placeholder="Event title" value={eventTitle}
                    ...
                    required />
                  <textarea placeholder="Description (optional)" value={eventDesc}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <input type="date" value={eventDate} onChange={(e) => setEventDate(e.target.value)}
                      className="bg-background border border-border rounded-2xl py-3 px-4 text-sm text-foreground focus:outline-none focus:border-accent/50" required />
                  ...
                  <div className="flex gap-3">
                    ...
                    <button type="button" onClick={() => setShowEventForm(false)} className="btn-secondary px-6 py-2.5 rounded-2xl text-sm">Cancel</button>
                  </div>
                </form>
              </div>
            )}
            ...
            {Object.keys(groupedEvents).length === 0 ? (
              ...
              Object.entries(groupedEvents).map(([dateKey, dateEvents]) => (
                <div key={dateKey} className="mb-8 animate-slide-up">
